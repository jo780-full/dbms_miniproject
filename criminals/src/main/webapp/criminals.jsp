...
try{
	...
	PreparedStatement psd=con.prepareStatement("insert into criminals(criminal_name,cid,phone,arrested_by,crime_committed,age,weight,eyecolor,uidm,status_aftercrime,judicial_status,address,pid) values(?,?,?,?,?,?,?,?,?,?,?,?,?)");
