...
line-height: 25px;
 ...
 Class.forName("com.mysql.cj.jdbc.Driver");
    ...
    %>
            ...
            <br>
            <input style="width:400px;height:65px;border-radius:10px" type="text" name="cids" placeholder="Enter the Officer id here">
...
if(i==0)  
{
	   ...
	   {
		   %>
		  <p>The given Criminal with id given does not exist</p>
		   <%
	   }
}
catch(Exception e)
